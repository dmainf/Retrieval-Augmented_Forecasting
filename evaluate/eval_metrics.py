...
def main():
    parser = argparse.ArgumentParser(description="Evaluate metrics and save per-step error distribution comparison")
    ...
    for path in csvs:
        ...
        rows.append({"Model": label, "MAE": round(mae, 6), "MSE": round(mse, 6)})
